...
from ...repositories.onboarding.onboarding_progress_repository import OnboardingProgressRepository
...
class OnboardingProgressService:
    ...
    async def update_progress_on_action(
        ...
        try:
            ...
            logger.info(f"Updated progress for user {user['id']}: action={action}, step={progress_step}")
