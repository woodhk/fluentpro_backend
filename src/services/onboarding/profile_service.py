...
class ProfileService:
    ...
    async def update_industry(self, auth0_id: str, industry: Industry) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Successfully updated industry to {industry.value} for user {user['id']}")
