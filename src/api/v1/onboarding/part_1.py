...
async def set_native_language(
    ...
    logger.info(
        f"Setting native language for user {auth0_id} to {language_request.native_language}"
    )
    ...
    try:
        ...
        result = await profile_service.update_native_language(
            auth0_id=auth0_id, native_language=language_request.native_language
        )
...
async def set_industry(
    ...
    try:
        ...
        result = await profile_service.update_industry(
            auth0_id=auth0_id, industry=industry_request.industry
        )
...
async def select_role(
    ...
    try:
        ...
        await progress_service.update_progress_on_action(
            auth0_id=auth0_id, action="select_role", action_data=progress_data
        )
