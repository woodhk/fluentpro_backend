...
class AzureSearchClient:
    ...
    async def create_index(self):
        ...
        fields = [
            ...
            SearchableField(
                name="search_keywords", type=SearchFieldDataType.String, searchable=True
            ),
            SimpleField(
                name="industry_id", type=SearchFieldDataType.String, filterable=True
            ),
            SimpleField(
                name="industry_name", type=SearchFieldDataType.String, filterable=True
            ),
            SimpleField(
                name="is_system_role", type=SearchFieldDataType.Boolean, filterable=True
            ),
            SearchField(
                name="embedding",
        ...
        vector_search = VectorSearch(
            ...
            profiles=[
                VectorSearchProfile(
                    name="role-vector-profile", algorithm_configuration_name="hnsw-algo"
                )
            ],
        )
    ...
    async def search_roles(
        self, embedding: List[float], industry_id: str, top_k: int = 5
    ) -> List[Dict[str, Any]]:
