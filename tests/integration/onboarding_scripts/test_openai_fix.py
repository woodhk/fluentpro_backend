...
def test_description_rewriting():
    ...
    rewritten_1 = openai_service.rewrite_job_description(
        "Crypto Trading Analyst", test_description_1
    )

    print(f"   Rewritten: {rewritten_1}")
    print(f"   ✅ Contains markdown? {'**' in rewritten_1 or '#' in rewritten_1}")
    print(
        f"   ✅ Contains job title repetition? {'Crypto Trading Analyst' in rewritten_1}"
    )
    print(
        f"   ✅ Contains 'Job Title:' or 'Description:'? {'Job Title:' in rewritten_1 or 'Description:' in rewritten_1}"
    )
    ...
    rewritten_2 = openai_service.rewrite_job_description(
        "Financial Analyst", test_description_2
    )
    ...
    print(
        f"   ✅ Contains 'Job Title:' or 'Description:'? {'Job Title:' in rewritten_2 or 'Description:' in rewritten_2}"
    )
...
This role involves analyzing data and creating reports. Works with various tools and technologies."""
    ...
    print(
        f"   ✅ Successfully cleaned? {not ('**' in cleaned or 'Job Title:' in cleaned or 'Description:' in cleaned)}"
    )
